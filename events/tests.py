...
class TestEventViews(TestCase):
    ...
    def test_get_edit_event_page(self):
        ...
        page = self.client.get("/events/view_one_event/edit_event/{0}"
    ...
    def test_delete_one_event(self):
        ...
        page = self.client.get("/events/view_one_event/delete_event/{0}"
                               .format(test_event.id))
        self.assertEqual(page.status_code, 302)
    ...
    def test_delete_participant(self):
        ...
        self.client.force_login(test_user)
        page = self.client.get("/events/view_one_event/delete_participant/{0}"
    ...
    def test_delete_like(self):
        ...
        self.client.force_login(test_user)
        page = self.client.get("/events/view_one_event/delete_like/{0}"
                               .format(like.id))
        self.assertEqual(page.status_code, 302)
