...
class Event(models.Model):
    ...
    age_range = models.CharField(max_length=20, choices=AGE_RANGE_CHOICES,
                                 blank=False, default="Please Choose")
    address = models.CharField(max_length=60)
    town = models.CharField(max_length=20, choices=TOWN_CHOICES, blank=False,
    ...
    event_day = models.CharField(max_length=20, choices=DAY_CHOICES,
                                 blank=False, default="Please Choose")
