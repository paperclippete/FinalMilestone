...
urlpatterns = [
    path('', password_reset, {'post_reset_redirect': reverse_lazy('password_reset_done'), 'html_email_template_name': 'registration/html_email_password_reset.html'}, name='password_reset'),
